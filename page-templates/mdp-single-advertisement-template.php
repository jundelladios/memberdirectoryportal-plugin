    ...
    <div class="mdp-mb5">
      <div class="mdp-panel">
        ...
        <div class="mdp-info mdp-padding">
          ...
          <div>
            <p><?php echo memberdirectoryportal_js_dateformat('F j, Y @ h:i A', strtotime($ads->offer_start)); ?></p>
            <?php if(!$ads->no_expiration): ?>
            <p><?php echo memberdirectoryportal_js_dateformat('F j, Y @ h:i A', strtotime($ads->offser_end)); ?></p>
            <?php endif; ?>
          </div>
        </div>
